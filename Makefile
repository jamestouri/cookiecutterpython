...
ve_python3_exe:=${UNITTEST_VE_DIR}/bin/python3
ve_pip3_cmd:=${ve_python3_exe} -m pip

unittest_install_cmd:=${ve_pip3_cmd} install --editable ${UNITTEST_DIR}

_ve_build:
# build ve
	${sys_python3_exe} -m venv ${UNITTEST_DIR}/ve
# pip update
